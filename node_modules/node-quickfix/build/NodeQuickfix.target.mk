...
TARGET := NodeQuickfix
DEFS_Debug := \
	'-DNODE_GYP_MODULE_NAME=NodeQuickfix' \
	'-DUSING_UV_SHARED=1' \
	'-DUSING_V8_SHARED=1' \
...
OBJS := \
	...
	$(obj).target/$(TARGET)/src/FixLoginResponse.o \
...
$(obj).target/NodeQuickfix.node: GYP_LDFLAGS := $(LDFLAGS_$(BUILDTYPE))
$(obj).target/NodeQuickfix.node: LIBS := $(LIBS)
$(obj).target/NodeQuickfix.node: TOOLSET := $(TOOLSET)
$(obj).target/NodeQuickfix.node: $(OBJS) FORCE_DO_CMD
	$(call do_cmd,solink_module)

all_deps += $(obj).target/NodeQuickfix.node
# Add target alias
.PHONY: NodeQuickfix
NodeQuickfix: $(builddir)/NodeQuickfix.node

# Copy this to the executable output path.
$(builddir)/NodeQuickfix.node: TOOLSET := $(TOOLSET)
$(builddir)/NodeQuickfix.node: $(obj).target/NodeQuickfix.node FORCE_DO_CMD
	$(call do_cmd,copy)

all_deps += $(builddir)/NodeQuickfix.node
# Short alias for building this executable.
.PHONY: NodeQuickfix.node
NodeQuickfix.node: $(obj).target/NodeQuickfix.node $(builddir)/NodeQuickfix.node

# Add executable to "all" target.
.PHONY: all
all: $(builddir)/NodeQuickfix.node
